...
DefineInnerModel <- function() {
  LearnEmbed 	         <- c(0, 0, 0, 0, 0, 0, 0)
	...
	SocialNetwork	       <- c(0, 0, 0, 0, 0, 0, 0)
	IndividualMotivation <- c(0, 0, 0, 1, 0, 0, 0)
	LearningCapability   <- c(1, 1, 0, 1, 1, 0, 0)
	InnovationAbility    <- c(0, 0, 1, 1, 1, 1, 0)
...
DefineOuterMode <- function(correctData) {
	...
	innovation_blocks <- list(
				  ...
				  GetIndex(colValues, testList[c(1:3,4,5:7)]), 

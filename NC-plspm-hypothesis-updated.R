...
DefineInnerModel <- function() {
  firmSize 	           <- c(0, 0, 0,  0, 0, 0, 0, 0)
  SocialClimate 	     <- c(1, 0, 0,  0, 0, 0, 0, 0)
	ExtMotivation        <- c(1, 1, 0,  0, 0, 0, 0, 0)
	IntrMotivation       <- c(1, 1, 1,  0, 0, 0, 0, 0)
	SocialNetwork	       <- c(1, 1, 1,  1, 0, 0, 0, 0)
	LearningCapability   <- c(1, 1, 1,  1, 1, 0, 0, 0)
	IncrementInnov         <- c(1, 1, 1,  1, 1, 1, 0, 0)
	RadicalInnov         <- c(1, 1, 1,  1, 1, 1, 1, 0)
	
	#Old model..
	SocialClimate 	     <- c(0, 0,  0, 0, 0, 0, 0)
	ExtMotivation        <- c(1, 0,  0, 0, 0, 0, 0)
	IntrMotivation       <- c(1, 1,  0, 0, 0, 0, 0)
	SocialNetwork	       <- c(1, 1,  1, 0, 0, 0, 0)
	LearningCapability   <- c(1, 1,  1, 1, 0, 0, 0)
	ProcessInnov         <- c(1, 1,  1, 1, 1, 0, 0)
	ProductInnov         <- c(1, 1,  1, 1, 1, 1, 0)
	...
	ExtMotivation        <- c(1, 0,  0, 0, 0, 0, 0)
	IntrMotivation       <- c(1, 1,  0, 0, 0, 0, 0)
	SocialNetwork	       <- c(1, 0,  1, 0, 0, 0, 0)
	LearningCapability   <- c(1, 1,  1, 1, 0, 0, 0)
	ProcessInnov         <- c(0, 1,  1, 1, 1, 0, 0)
	ProductInnov         <- c(0, 1,  1, 1, 1, 1, 0)
